...
private slots:
    ...
    QString BuyETHCA(QString OrderType, double Quantity, double Rate);
    QString SellETHCA(QString OrderType, double Quantity, double Rate);
