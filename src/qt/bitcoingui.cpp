...
{
    resize(900, 520);
    setWindowTitle(tr("EthCash") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
#endif
    setObjectName("ethcash");
    setStyleSheet("#ethcash { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #dedede, stop: 1 #efefef);  }");
    // Accept D&D of URIs
    setAcceptDrops(true);
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a EthCash address"));
	...
	pioAction = new QAction(QIcon(":/icons/web"), tr("&EthCash Website"), this);
	pioAction->setToolTip(tr("Visit the Official EthCash website"));
	bitcointalkAction = new QAction(QIcon(":/icons/bitcointalk"), tr("&Bitcointalk Discussion"), this);
	bitcointalkAction->setToolTip(tr("Visit the Bitcointalk EthCash discussion thread"));
	chainAction = new QAction(QIcon(":/icons/slack"), tr("&EthCash Slack"), this);
	chainAction->setToolTip(tr("Join EthCash Slack"));	
	explorerAction = new QAction(QIcon(":/icons/explorer"), tr("&EthCash Explorer"), this);
	explorerAction->setToolTip(tr("EthCash Explorer"));	
    aboutAction = new QAction(tr("&About EthCash"), this);
    aboutAction->setToolTip(tr("Show information about EthCash"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for EthCash"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("EthCash client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("EthCash client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to EthCash network", "", count));
}
...
void BitcoinGUI::gotoinvestPage()
{
  investAction->setChecked(true);
	...
	if ( investtimestamp > timestamp ) { 
	 ...
	 QDesktopServices::openUrl(QUrl("https://invest.ethcash.io"));
	 }
	}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid EthCash address or malformed URI parameters."));
    }
...
{
    QDesktopServices::openUrl(QUrl("http://www.ethcash.io"));
}

void BitcoinGUI::bitcointalkClicked()
{
    QDesktopServices::openUrl(QUrl("http://bitcointalk.ethcash.io"));
}

void BitcoinGUI::chainClicked()
{
    QDesktopServices::openUrl(QUrl("https://ethcash.herokuapp.com"));
}
void BitcoinGUI::explorerClicked()
{
    QDesktopServices::openUrl(QUrl("https://ethcash.info"));
}
