...
int nAnonymizeethcashAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\EthCash
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\EthCash
    // Mac: ~/Library/Application Support/EthCash
    // Unix: ~/.ethcash
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "EthCash";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "ethcash.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "ethcashd.pid"));
